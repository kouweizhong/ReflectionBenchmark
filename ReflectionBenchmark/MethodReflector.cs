...
namespace ReflectionBenchmark.Net4
{
    public sealed class MethodReflector
    {
        ...
        private Func<object, object[], object> InternalCreateMethodInvoker()
        {
            ...
            ilGen.EmitCall((_method.IsStatic || _method.DeclaringType.IsValueType || !_isCallvirt) ? OpCodes.Call : OpCodes.Callvirt, _method, null);
    ...
    {
        public static Type MakeDefType(this Type byRefTypeInfo)
        {
